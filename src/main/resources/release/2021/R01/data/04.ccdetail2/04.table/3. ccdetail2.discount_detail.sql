CREATE TABLE ccdetail2.discount_detail(
...
COMMENT ON TABLE ccdetail2.discount_detail
     IS 'Discount Detail';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_appl_order
     IS 'Application order.';
COMMENT ON COLUMN ccdetail2.discount_detail.bd_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ccdetail2.discount_detail.bd_usage_date
     IS 'Usage date.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_level_code
     IS 'Level code.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_promo_type
     IS 'Promotion type.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_cond_type
     IS 'Condition type.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_promo_num
     IS 'Promotion number.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_cap_rank
     IS 'Capped incentive rank.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_discount_usd
     IS 'Non-capped discount amount applied to regular override charge in USD.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_discount_cur
     IS 'Non-capped discount amount applied to regular override charge in customer currency.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_discount_pcnt
     IS 'Discount percent.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_domain
     IS 'Domain.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_company_id
     IS 'Company code.';
COMMENT ON COLUMN ccdetail2.discount_detail.dd_offer_id
