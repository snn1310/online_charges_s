CREATE TABLE ccdetail2.customer_detail(
...
COMMENT ON TABLE ccdetail2.customer_detail
     IS 'Customer Detail';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_user_id
     IS 'User id.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_usage_date
     IS 'Usage date.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_company_id
     IS 'Company code.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_contact_num
     IS 'Contact number.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_bill_grp
     IS 'Billing group.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_pay_grp
     IS 'Payment group.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_org_partner
     IS 'Organization partner.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_mat_price_grp
     IS 'Ancillary subscription material price group.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_juris_code
     IS 'Tax jurisdiction code.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_tax_class
     IS 'Customer tax class.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_country_code
     IS 'Country code.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_vat_reg_num
     IS 'VAT registration number.';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_city
     IS 'City';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_state
     IS 'State';
COMMENT ON COLUMN ccdetail2.customer_detail.cd_postal_code
     IS 'Postal Code';
