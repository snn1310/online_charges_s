...
COMMENT ON TABLE ccdetail2.warn
     IS 'Warn';
COMMENT ON COLUMN ccdetail2.warn.w_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail2.warn.sgd_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail2.warn.w_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ccdetail2.warn.w_warn_type
     IS 'Warn type.';
COMMENT ON COLUMN ccdetail2.warn.w_database_name
     IS 'Database name.';
COMMENT ON COLUMN ccdetail2.warn.w_timestamp
     IS 'Timestamp.';
COMMENT ON COLUMN ccdetail2.warn.w_document_name
     IS 'Document name.';
COMMENT ON COLUMN ccdetail2.warn.w_meter_code
     IS 'Meter code.';
COMMENT ON COLUMN ccdetail2.warn.w_access_method
     IS 'Access method.';
