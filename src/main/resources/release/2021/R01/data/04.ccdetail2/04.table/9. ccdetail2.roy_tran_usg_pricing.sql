CREATE TABLE ccdetail2.roy_tran_usg_pricing(
...
COMMENT ON TABLE ccdetail2.roy_tran_usg_pricing
     IS 'Royalty Transaction Usage Pricing';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.cd_id
     IS 'Generated id from customer_detail';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtu_id
     IS 'Generated id from royalty_tran_usage.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_session_start_date
     IS 'Session start date, used for partitions.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_usage_date
     IS 'Usage date.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_usage_type
     IS 'Usage type.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_db_mat_num
     IS 'Database material number.';
COMMENT ON COLUMN ccdetail2.roy_tran_usg_pricing.rtup_vendor_code
