CREATE TABLE ccdetail2.session_status(
...
COMMENT ON TABLE ccdetail2.session_status
     IS 'Session Status';
COMMENT ON COLUMN ccdetail2.session_status.ss_session_id
     IS 'Session id.';
COMMENT ON COLUMN ccdetail2.session_status.ss_modified_by
     IS 'Modified by.';
COMMENT ON COLUMN ccdetail2.session_status.ss_mod_timestamp
