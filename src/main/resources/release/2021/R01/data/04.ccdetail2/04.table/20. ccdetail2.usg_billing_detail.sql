CREATE TABLE ccdetail2.usg_billing_detail(
...
COMMENT ON TABLE ccdetail2.usg_billing_detail
     IS 'Usage Billing Detail';
COMMENT ON COLUMN ccdetail2.usg_billing_detail.ubd_usage_id
     IS 'Id of usage we are linking to.';
COMMENT ON COLUMN ccdetail2.usg_billing_detail.bd_id
     IS 'bd_id from billing detail table.  Used to link usage and billing data.';
COMMENT ON COLUMN ccdetail2.usg_billing_detail.ubd_session_start_date
