CREATE TABLE ccdetail4.segment_detail(
...
COMMENT ON TABLE ccdetail4.segment_detail
     IS 'Segment Detail';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail4.segment_detail.ssd_id
     IS 'SESSION_DETAIL id.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_database_name
     IS 'Database name.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_start_time
     IS 'Segment start time.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_end_time
     IS 'Segment end time.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_seconds
     IS 'Segment elapsed seconds count.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_comp_code
     IS 'Segment Detail status code.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_client_id_text
     IS 'Client id text.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_meter_code
     IS 'Meter code.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_access_method
     IS 'Access method.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_find_type
     IS 'Find type.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_udm_ind
     IS 'User defined multibase indicator.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_udm_id
     IS 'User defined multibase id.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_doc_origin
     IS 'Document origin.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_doc_type
     IS 'Document type.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_com_ov_flag
     IS 'Communication override flag.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_ct_ov_flag
     IS 'sgd_ct_ov_flag';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_db_ov_flag
     IS 'Database override flag.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_price_code
     IS 'Price code.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_tier_ind
     IS 'Indicates if a tier applies to this usage.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_tier_id
     IS 'Links this usage to other usage in this tier.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_tier_code
     IS 'What type of tier this usage is.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_trail_code
     IS 'Trail code logged by the application for each segment.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_capped_client_id
     IS 'Capped client id.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_capped_billable_ind
     IS 'Capped billable indicator.';
COMMENT ON COLUMN ccdetail4.segment_detail.sgd_cap_ind
     IS 'Cap indicator.';
