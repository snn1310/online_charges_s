CREATE TABLE ocsumm1.vip_monitoring(
...
COMMENT ON TABLE ocsumm1.vip_monitoring
     IS 'VIP Monitoring';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_id
     IS 'Generated id';
COMMENT ON COLUMN ocsumm1.vip_monitoring.c_id
     IS 'Generated id to link to customer table';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_domain
     IS 'Domain';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_date
     IS 'Usage Date';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_timestamp
     IS 'Timestamp';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_database_name
     IS 'Database name';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_query_text
     IS 'Query text from search.';
COMMENT ON COLUMN ocsumm1.vip_monitoring.vm_long_encrypted_query_text
