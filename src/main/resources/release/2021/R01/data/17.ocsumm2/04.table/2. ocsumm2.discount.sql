...
COMMENT ON TABLE ocsumm2.discount
     IS 'Discount';
COMMENT ON COLUMN ocsumm2.discount.d_appl_order
     IS 'Discount application order.';
COMMENT ON COLUMN ocsumm2.discount.u_id
     IS 'Generated id to link to usage table';
COMMENT ON COLUMN ocsumm2.discount.c_id
     IS 'Generated id to link to customer table.';
COMMENT ON COLUMN ocsumm2.discount.d_domain
     IS 'Domain';
COMMENT ON COLUMN ocsumm2.discount.d_company_id
     IS 'Company id';
COMMENT ON COLUMN ocsumm2.discount.d_date
     IS 'usage date.';
COMMENT ON COLUMN ocsumm2.discount.d_level_code
     IS 'level code';
COMMENT ON COLUMN ocsumm2.discount.d_promo_type
     IS 'promotion type';
COMMENT ON COLUMN ocsumm2.discount.d_cond_type
     IS 'condition type';
COMMENT ON COLUMN ocsumm2.discount.d_promo_num
     IS 'Promotion number.';
COMMENT ON COLUMN ocsumm2.discount.d_cap_rank
     IS 'Cap rank';
COMMENT ON COLUMN ocsumm2.discount.d_discount_usd
     IS 'Discount in USD';
COMMENT ON COLUMN ocsumm2.discount.d_discount_cur
     IS 'Discount in a foreign currency.';
COMMENT ON COLUMN ocsumm2.discount.d_discount_pcnt
     IS 'Discount percent.';
COMMENT ON COLUMN ocsumm2.discount.d_offer_id
     IS 'Promotion offer id.';
COMMENT ON COLUMN ocsumm2.discount.d_promo_applied
