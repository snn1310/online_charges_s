CREATE TABLE ocprice.config_value(
...
COMMENT ON COLUMN ocprice.config_value.cv_id
     IS 'GUID.';
COMMENT ON COLUMN ocprice.config_value.cv_domain
     IS 'Config domain name.';
COMMENT ON COLUMN ocprice.config_value.cv_company_code
     IS 'Config company code.';
COMMENT ON COLUMN ocprice.config_value.cv_config_item
     IS 'Config item name.';
COMMENT ON COLUMN ocprice.config_value.cv_config_item_value
     IS 'Config value name.';
COMMENT ON COLUMN ocprice.config_value.cv_eff_date
     IS 'Date config value is active.';
COMMENT ON COLUMN ocprice.config_value.cv_end_date
     IS 'Date config value expires.';
COMMENT ON COLUMN ocprice.config_value.cv_modified_by
     IS 'Last modified by.';
COMMENT ON COLUMN ocprice.config_value.cv_mod_timestamp
     IS 'Timestamp of last modify.';
COMMENT ON COLUMN ocprice.config_value.cv_sap_valid_value_ind
     IS 'Valid Value is used by SAP.';
COMMENT ON COLUMN ocprice.config_value.cv_usage_valid_value_ind
     IS 'Valid Value is used by Usage Processors.';
COMMENT ON COLUMN ocprice.config_value.cv_value_desc
