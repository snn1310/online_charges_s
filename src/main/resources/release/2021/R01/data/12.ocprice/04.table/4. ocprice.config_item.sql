CREATE TABLE ocprice.config_item(
...
COMMENT ON COLUMN ocprice.config_item.ci_config_item
     IS 'Config item name.';
COMMENT ON COLUMN ocprice.config_item.ci_multivalued
     IS 'Allow multiple config values.';
COMMENT ON COLUMN ocprice.config_item.ci_description
     IS 'Description of the config item.';
COMMENT ON COLUMN ocprice.config_item.ci_modified_by
     IS 'Last modified by.';
COMMENT ON COLUMN ocprice.config_item.ci_mod_timestamp
