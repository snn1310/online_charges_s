CREATE TABLE ocdetail.tran_royalty(
...
COMMENT ON TABLE ocdetail.tran_royalty
     IS 'Transaction Royalty';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_id
     IS 'Generated id.';
COMMENT ON COLUMN ocdetail.tran_royalty.tu_id
     IS 'Generated id from transaction_usage.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_royalty_id
     IS 'Royalty identifier.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_char_cnt
     IS 'Document character count.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_line_cnt
     IS 'Line count.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_doc_cnt
     IS 'Document count.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_royalty_data
     IS 'Royalty data.';
COMMENT ON COLUMN ocdetail.tran_royalty.trr_from_tu_id
     IS 'From tu id.';
