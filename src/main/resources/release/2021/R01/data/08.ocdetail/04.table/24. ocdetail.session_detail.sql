CREATE TABLE ocdetail.session_detail(
...
COMMENT ON TABLE ocdetail.session_detail
     IS 'Session Detail';
COMMENT ON COLUMN ocdetail.session_detail.ssd_id
     IS 'Generated id.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_user_id
     IS 'User id.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_session_id
     IS 'Unique session id.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_domain
     IS 'Domain';
COMMENT ON COLUMN ocdetail.session_detail.ssd_session_type
     IS 'Session type.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_start_time
     IS 'Session start time.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_end_time
     IS 'Session end time.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_seconds
     IS 'Seconds.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_comp_code
     IS 'Session completion code.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_software_type
     IS 'Software type.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_software_ver
     IS 'Software version.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_meter_code
     IS 'Meter code.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_onl_serv_type
     IS 'Service type.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_billing_option
     IS 'Billing option.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_platform_code
     IS 'Platform code.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_net_orig_addr
     IS 'Network origination address.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_net_dest_addr
     IS 'Network destination address.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_net_trunk_name
     IS 'Network trunk name.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_net_speed
     IS 'Network speed.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_front_end_proc
     IS 'Front end process.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_onl_session_id
     IS 'Online session id initiating a print delivery session.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_dest_code
     IS 'Destination code for print delivery sessions.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_print_bill_opt
     IS 'The print-specific billing option for transactions in a print session.';
COMMENT ON COLUMN ocdetail.session_detail.ssd_print_copy_cnt
