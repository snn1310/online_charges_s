CREATE TABLE ocdetail.warn_promo(
...
COMMENT ON TABLE ocdetail.warn_promo
     IS 'Warn Promotions';
COMMENT ON COLUMN ocdetail.warn_promo.wp_id
     IS 'Generated id.';
COMMENT ON COLUMN ocdetail.warn_promo.w_id
     IS 'Generated id from warn table.';
COMMENT ON COLUMN ocdetail.warn_promo.wp_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ocdetail.warn_promo.wp_promo_num
     IS 'Promotion number.';
