CREATE TABLE ocdetail.session_status(
...
COMMENT ON TABLE ocdetail.session_status
     IS 'Session Status';
COMMENT ON COLUMN ocdetail.session_status.ss_session_id
     IS 'Session id.';
COMMENT ON COLUMN ocdetail.session_status.ss_modified_by
     IS 'Modified by.';
COMMENT ON COLUMN ocdetail.session_status.ss_mod_timestamp
