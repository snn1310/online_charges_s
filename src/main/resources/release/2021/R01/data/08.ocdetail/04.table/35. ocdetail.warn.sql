...
COMMENT ON TABLE ocdetail.warn
     IS 'Warn';
COMMENT ON COLUMN ocdetail.warn.w_id
     IS 'Generated id.';
COMMENT ON COLUMN ocdetail.warn.sgd_id
     IS 'Generated id.';
COMMENT ON COLUMN ocdetail.warn.w_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ocdetail.warn.w_warn_type
     IS 'Warn type.';
COMMENT ON COLUMN ocdetail.warn.w_database_name
     IS 'Database name.';
COMMENT ON COLUMN ocdetail.warn.w_timestamp
     IS 'Timestamp.';
COMMENT ON COLUMN ocdetail.warn.w_document_name
     IS 'Document name.';
COMMENT ON COLUMN ocdetail.warn.w_meter_code
     IS 'Meter code.';
COMMENT ON COLUMN ocdetail.warn.w_access_method
     IS 'Access method.';
