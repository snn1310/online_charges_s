CREATE TABLE ccdetail3.roy_tran_usg_detail(
...
COMMENT ON TABLE ccdetail3.roy_tran_usg_detail
     IS 'Royalty Transaction Usage Detail';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtud_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtu_id
     IS 'Generated id from royalty_tran_usage';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtud_session_start_date
     IS 'Session start date, used for partitions.';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtud_royalty_id
     IS 'Royalty id.';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtud_doc_cnt
     IS 'Print reporting document count.';
COMMENT ON COLUMN ccdetail3.roy_tran_usg_detail.rtud_from_tu_id
