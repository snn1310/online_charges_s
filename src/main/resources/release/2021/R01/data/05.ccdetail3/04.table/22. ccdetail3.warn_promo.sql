CREATE TABLE ccdetail3.warn_promo(
...
COMMENT ON TABLE ccdetail3.warn_promo
     IS 'Warn Promotions';
COMMENT ON COLUMN ccdetail3.warn_promo.wp_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail3.warn_promo.w_id
     IS 'Generated id from warn table.';
COMMENT ON COLUMN ccdetail3.warn_promo.wp_session_start_date
     IS 'Session start date, used for partitioning.';
COMMENT ON COLUMN ccdetail3.warn_promo.wp_promo_num
     IS 'Promotion number.';
