CREATE TABLE ccdetail1.error_log(
...
COMMENT ON TABLE ccdetail1.error_log
     IS 'Online Charges Error Log';
COMMENT ON COLUMN ccdetail1.error_log.el_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail1.error_log.el_ins_date
     IS 'Error log insert date, used for partitioning.';
COMMENT ON COLUMN ccdetail1.error_log.eh_id
     IS 'Generated id.';
COMMENT ON COLUMN ccdetail1.error_log.el_user_id
     IS 'User id.';
COMMENT ON COLUMN ccdetail1.error_log.el_severity_code
     IS 'Error severity code.';
COMMENT ON COLUMN ccdetail1.error_log.el_message_text
     IS 'Error message text.';
COMMENT ON COLUMN ccdetail1.error_log.el_category_code
     IS 'Error category code.';
COMMENT ON COLUMN ccdetail1.error_log.el_process_name
     IS 'Process name of error origination.';
COMMENT ON COLUMN ccdetail1.error_log.el_context_data
     IS 'Context data.';
COMMENT ON COLUMN ccdetail1.error_log.el_stack_trace
     IS 'Stack trace.';
COMMENT ON COLUMN ccdetail1.error_log.el_ins_timestamp
     IS 'Row insert timestamp.';
COMMENT ON COLUMN ccdetail1.error_log.el_cause_id
     IS 'Cause OC_ERROR_LOG id.';
COMMENT ON COLUMN ccdetail1.error_log.el_domain
     IS 'Domain.';
COMMENT ON COLUMN ccdetail1.error_log.el_short_message
     IS 'Short message.';
COMMENT ON COLUMN ccdetail1.error_log.el_session_id
     IS 'Session id.';
