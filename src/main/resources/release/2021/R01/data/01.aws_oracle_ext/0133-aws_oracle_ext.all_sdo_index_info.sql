CREATE OR REPLACE VIEW aws_oracle_ext.all_sdo_index_info AS
SELECT p.tableowner::CHARACTER VARYING(32) AS sdo_index_owner,
...
COMMENT ON VIEW aws_oracle_ext.all_sdo_index_info IS
'Contains index information for all spatial tables on which the user has SELECT permission.';
