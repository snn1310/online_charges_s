create or replace view aws_oracle_ext.SYS_DBA_TABLES as
select 
...
and t.schemaname not in ('pg_catalog', 'information_schema', 'public_synonyms');


comment on view aws_oracle_ext.SYS_DBA_TABLES is
'The SYS.DBA_TABLES view describes all tables in the database.';