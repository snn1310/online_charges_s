create or replace view aws_oracle_ext.sys_user_indexes as
select
...
COMMENT ON VIEW aws_oracle_ext.sys_user_indexes IS 'USER_INDEXES describes the indexes owned by the current user.';
