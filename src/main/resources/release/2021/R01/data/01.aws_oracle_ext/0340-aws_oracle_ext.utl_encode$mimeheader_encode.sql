create or replace function aws_oracle_ext.UTL_ENCODE$MIMEHEADER_ENCODE(buf character varying, encode_charset character varying default null, encoding_flag integer default null)  returns CHARACTER VARYING as 
$BODY$  
BEGIN
