create or replace view aws_oracle_ext.SYS_USER_OBJECTS as
select 
...
where u.usename = user and n.nspname not in ('pg_catalog', 'information_schema', 'public_synonyms');

comment on view aws_oracle_ext.SYS_USER_OBJECTS is
