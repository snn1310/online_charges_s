create or replace view aws_oracle_ext.sys_dba_indexes as
select
...
COMMENT ON VIEW aws_oracle_ext.sys_dba_indexes IS 'DBA_INDEXES describes all indexes in the database.';
