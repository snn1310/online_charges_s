create or replace view aws_oracle_ext.SYS_USER_TABLES as
select 
...
where 
  t.tableowner = user and 
  t.schemaname not in ('pg_catalog', 'information_schema', 'public_synonyms');

comment on view aws_oracle_ext.SYS_USER_TABLES is
