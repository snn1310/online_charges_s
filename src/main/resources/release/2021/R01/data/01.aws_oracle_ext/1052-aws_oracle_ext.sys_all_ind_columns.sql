create or replace view aws_oracle_ext.sys_all_ind_columns as
select
...
COMMENT ON VIEW aws_oracle_ext.sys_all_ind_columns IS 'ALL_IND_COLUMNS describes the columns of indexes on all tables accessible to the current user.';
