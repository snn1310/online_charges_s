CREATE TABLE ocentitlements.cross_domain_map(
...
COMMENT ON COLUMN ocentitlements.cross_domain_map.sg_security_group_id
     IS 'Cross domain group ID.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.sg_domain
     IS 'Cross domain group domain.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_version
     IS 'Cross domain map version.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_eff_date
     IS 'Dependent group effective date in the map.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_end_date
     IS 'Dependent group end date in the map.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_dep_security_group_id
     IS 'Dependent group Prism id.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_dep_domain
     IS 'Dependent group domain.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_modified_by
     IS 'User or system performing modification.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_mod_timestamp
     IS 'Timestamp when last modified.';
COMMENT ON COLUMN ocentitlements.cross_domain_map.cdm_company_code
