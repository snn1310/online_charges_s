CREATE TABLE ocentitlements.security_group(
...
COMMENT ON COLUMN ocentitlements.security_group.sg_security_group_id
     IS 'Security group ID.';
COMMENT ON COLUMN ocentitlements.security_group.sg_domain
     IS 'Security group domain.';
COMMENT ON COLUMN ocentitlements.security_group.sg_eff_date
     IS 'Prism group effective date.';
COMMENT ON COLUMN ocentitlements.security_group.sg_end_date
     IS 'Prism group end date.';
COMMENT ON COLUMN ocentitlements.security_group.sg_security_group_type
     IS 'Prism group type.';
COMMENT ON COLUMN ocentitlements.security_group.sg_description
     IS 'Security group description.';
COMMENT ON COLUMN ocentitlements.security_group.sg_data_owner
     IS 'Data owner that created the group.';
COMMENT ON COLUMN ocentitlements.security_group.sg_modified_by
     IS 'User or system performing modification.';
COMMENT ON COLUMN ocentitlements.security_group.sg_mod_timestamp
     IS 'Timestamp when last modified.';
COMMENT ON COLUMN ocentitlements.security_group.sg_company_code
