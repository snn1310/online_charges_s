CREATE TABLE ccdetail.limit_accumulation(
...
COMMENT ON TABLE ccdetail.limit_accumulation
     IS 'Limit accumulation.';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_domain
     IS 'Domain the User ID belongs to.';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_eff_date
     IS 'Date on which the limit is first effective.';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_usage_type
     IS 'Usage Type to which the limit applies.';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_unit
     IS 'Unit of measure for the limit';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_end_date
     IS 'Date on which the limit ends.';
COMMENT ON COLUMN ccdetail.limit_accumulation.la_accumulated
