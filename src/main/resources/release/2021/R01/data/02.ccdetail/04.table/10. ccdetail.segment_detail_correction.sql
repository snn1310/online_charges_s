CREATE TABLE ccdetail.segment_detail_correction(
...
COMMENT ON TABLE ccdetail.segment_detail_correction
     IS 'Segment Detail';
COMMENT ON COLUMN ccdetail.segment_detail_correction.ssd_id
     IS 'SESSION_DETAIL id.';
COMMENT ON COLUMN ccdetail.segment_detail_correction.sdc_capped_client_id
     IS 'Capped client id.';
COMMENT ON COLUMN ccdetail.segment_detail_correction.sdc_capped_billable_ind
     IS 'Capped billable indicator.';
COMMENT ON COLUMN ccdetail.segment_detail_correction.sdc_cap_ind
     IS 'Cap indicator.';
