CREATE TABLE ccdetail.router_control(
...
COMMENT ON COLUMN ccdetail.router_control.rc_id
     IS 'Generated ID';
COMMENT ON COLUMN ccdetail.router_control.rc_instance_name
     IS 'Application instanceName property';
COMMENT ON COLUMN ccdetail.router_control.rc_server_name
     IS 'Server hosting the instance';
COMMENT ON COLUMN ccdetail.router_control.rc_location
     IS 'Server site location';
COMMENT ON COLUMN ccdetail.router_control.rc_process_idle
     IS 'Process idle indicator';
COMMENT ON COLUMN ccdetail.router_control.rc_available_sites
     IS 'List of available sites';
COMMENT ON COLUMN ccdetail.router_control.rc_modified_by
     IS 'Modified by';
COMMENT ON COLUMN ccdetail.router_control.rc_mod_timestamp
